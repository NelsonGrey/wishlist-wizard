...
class EnhancedProductExtractor {
  constructor() {
    this.extractors = new Map([
      // Amazon variants
      ['amazon.com', this.extractAmazonProduct.bind(this)],
      ['amazon.ca', this.extractAmazonProduct.bind(this)],
      ['amazon.co.uk', this.extractAmazonProduct.bind(this)],
      ['amazon.de', this.extractAmazonProduct.bind(this)],
      ['amazon.fr', this.extractAmazonProduct.bind(this)],
      ['amazon.it', this.extractAmazonProduct.bind(this)],
      ['amazon.es', this.extractAmazonProduct.bind(this)],
      ['amazon.co.jp', this.extractAmazonProduct.bind(this)],
      ['amazon.in', this.extractAmazonProduct.bind(this)],
      ['amazon.com.br', this.extractAmazonProduct.bind(this)],
      ['amazon.com.mx', this.extractAmazonProduct.bind(this)],
      ['amazon.com.au', this.extractAmazonProduct.bind(this)],
      
      // Major retailers
      ['target.com', this.extractTargetProduct.bind(this)],
      ['walmart.com', this.extractWalmartProduct.bind(this)],
      ['ebay.com', this.extractEbayProduct.bind(this)],
      ['bestbuy.com', this.extractBestBuyProduct.bind(this)],
      ['etsy.com', this.extractEtsyProduct.bind(this)],
      
      // Home & furniture
      ['wayfair.com', this.extractWayfairProduct.bind(this)],
      ['overstock.com', this.extractOverstockProduct.bind(this)],
      ['homedepot.com', this.extractHomeDepotProduct.bind(this)],
      ['lowes.com', this.extractLowesProduct.bind(this)],
      ['ikea.com', this.extractIkeaProduct.bind(this)],
      
      // Fashion & department stores
      ['macys.com', this.extractMacysProduct.bind(this)],
      ['nordstrom.com', this.extractNordstromProduct.bind(this)],
      ['kohls.com', this.extractKohlsProduct.bind(this)],
      ['jcpenney.com', this.extractJCPenneyProduct.bind(this)],
      ['zappos.com', this.extractZapposProduct.bind(this)],
      
      // Warehouse clubs
      ['costco.com', this.extractCostcoProduct.bind(this)],
      ['samsclub.com', this.extractSamsClubProduct.bind(this)],
      
      // Electronics & tech
      ['newegg.com', this.extractNeweggProduct.bind(this)],
      ['microcenter.com', this.extractMicroCenterProduct.bind(this)],
      ['bhphotovideo.com', this.extractBHPhotoProduct.bind(this)],
      
      // Specialty stores
      ['chewy.com', this.extractChewyProduct.bind(this)],
      ['petsmart.com', this.extractPetSmartProduct.bind(this)],
      ['ulta.com', this.extractUltaProduct.bind(this)],
      ['sephora.com', this.extractSephoraProduct.bind(this)],
      
      // Online marketplaces
      ['alibaba.com', this.extractAlibabaProduct.bind(this)],
      ['aliexpress.com', this.extractAliExpressProduct.bind(this)],
      ['wish.com', this.extractWishProduct.bind(this)],
      
      // Grocery & food
      ['instacart.com', this.extractInstacartProduct.bind(this)],
      ['kroger.com', this.extractKrogerProduct.bind(this)],
      
      // Automotive
      ['autozone.com', this.extractAutoZoneProduct.bind(this)],
      ['oreillyauto.com', this.extractOReillyProduct.bind(this)]
    ]);
  ...
  async extractWithRetry(attempt = 1) {
    try {
      ...
      if (this.extractors.has(siteName)) {
        const extractor = this.extractors.get(siteName);
        
        try {
          const result = await this.executeExtractorSafely(extractor, siteName);
          if (result && result.title && result.title.trim()) {
            return {
              success: true,
              productInfo: this.normalizeProductInfo(result, siteName),
              extractionMethod: siteName,
              attempts: attempt
            };
          }
        } catch (extractorError) {
          console.warn(`Site-specific extractor failed for ${siteName}:`, extractorError);
        }
      }
  ...
  /**
   * Amazon product extraction (works for all Amazon domains)
   */
  extractAmazonProduct() {
    ...
    return this.extractWithSelectors(selectors, 'Amazon');
  }

  /**
   * Target product extraction
   */
  extractTargetProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Target');
  }
  ...
  extractWalmartProduct() {
    ...
    return this.extractWithSelectors(selectors, 'Walmart');
  }
  ...
  extractEbayProduct() {
    const selectors = {
      ...
      price: [
        '.notranslate[data-testid="display-price"]',
        '#prcIsum',
        '.u-flL.condText'
      ],
      image: [
    ...
    return this.extractWithSelectors(selectors, 'eBay');
  }
  ...
  extractBestBuyProduct() {
    ...
    return this.extractWithSelectors(selectors, 'Best Buy');
  }

  /**
   * Etsy product extraction
   */
  extractEtsyProduct() {
    const selectors = {
      title: [
        'h1[data-test="listing-page-title"]',
        '.listing-page-title'
      ],
      price: [
        '.currency-value',
    ...
    return this.extractWithSelectors(selectors, 'Etsy');
  }

  /**
   * Wayfair product extraction
   */
  extractWayfairProduct() {
    const selectors = {
      title: [
        'h1[data-enzyme-id="ProductTitle"]',
        '.ProductDetailInfoBlock-title'
      ],
      price: [
        '[data-enzyme-id="PriceBlock"] .BasePriceBlock-priceValue',
        '.BasePriceBlock-price'
      ],
      image: [
        '.ProductImageCarousel-image img',
        '.ImageViewer-image img'
      ]
    };

    return this.extractWithSelectors(selectors, 'Wayfair');
  }

  /**
   * Overstock product extraction
   */
  extractOverstockProduct() {
    const selectors = {
      title: [
        'h1.product-title',
        '.product-info h1'
    ...
    return this.extractWithSelectors(selectors, 'Overstock');
  }
  ...
  extractHomeDepotProduct() {
    const selectors = {
      ...
      price: [
        '[data-testid="price"] .price-format__main-price',
        '.price-detailed__main .price-format__main'
      ],
      image: [
    ...
    return this.extractWithSelectors(selectors, 'Home Depot');
  }
  ...
  extractLowesProduct() {
    ...
    return this.extractWithSelectors(selectors, "Lowe's");
  }

  /**
   * Macy's product extraction
   */
  extractMacysProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, "Macy's");
  }

  /**
   * Nordstrom product extraction
   */
  extractNordstromProduct() {
    const selectors = {
      title: [
        'h1._1eaUd',
        '.product-title'
    ...
    return this.extractWithSelectors(selectors, 'Nordstrom');
  }

  /**
   * Kohl's product extraction
   */
  extractKohlsProduct() {
    const selectors = {
      title: [
      ...
      price: [
        '.prod_price_amounts .prod_price_reg',
        '.regular-price'
      ],
      image: [
        '.prod_img_main img',
    ...
    return this.extractWithSelectors(selectors, "Kohl's");
  }

  /**
   * Costco product extraction
   */
  extractCostcoProduct() {
    const selectors = {
      title: [
        'h1.product-title',
        '.product-h1'
    ...
    return this.extractWithSelectors(selectors, 'Costco');
  }

  /**
   * Sam's Club product extraction
   */
  extractSamsClubProduct() {
    const selectors = {
      title: [
        'h1[data-automation="product-title"]',
        '.product-title'
      ...
      price: [
        '[data-automation="pricing-current-price"]',
        '.current-price'
      ],
      image: [
        '.product-image img',
    ...
    return this.extractWithSelectors(selectors, "Sam's Club");
  }

  /**
   * IKEA product extraction
   */
  extractIkeaProduct() {
    const selectors = {
      title: [
      ...
      price: [
        '.pip-price__integer',
        '.pip-price .pip-price__sr-text'
      ],
      image: [
        '.pip-media__image img',
        '.pip-product-details__media img'
      ]
    };

    return this.extractWithSelectors(selectors, 'IKEA');
  }

  /**
   * JCPenney product extraction
   */
  extractJCPenneyProduct() {
    const selectors = {
      title: [
        'h1.product_name',
        '.product-title'
    ...
    return this.extractWithSelectors(selectors, 'JCPenney');
  }

  /**
   * Zappos product extraction
   */
  extractZapposProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Zappos');
  }

  /**
   * Newegg product extraction
   */
  extractNeweggProduct() {
    const selectors = {
      title: [
        'h1.product-title',
        '.product-wrap h1'
    ...
    return this.extractWithSelectors(selectors, 'Newegg');
  }

  /**
   * Micro Center product extraction
   */
  extractMicroCenterProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Micro Center');
  }

  /**
   * B&H Photo product extraction
   */
  extractBHPhotoProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'B&H Photo');
  }

  /**
   * Chewy product extraction
   */
  extractChewyProduct() {
    const selectors = {
      title: [
      ...
      image: [
        '.kib-product-image-box img',
        '.carousel-image img'
      ]
    };

    return this.extractWithSelectors(selectors, 'Chewy');
  }

  /**
   * PetSmart product extraction
   */
  extractPetSmartProduct() {
    const selectors = {
      title: [
        'h1.product-name',
        '.pdp-product-name'
    ...
    return this.extractWithSelectors(selectors, 'PetSmart');
  }

  /**
   * Ulta product extraction
   */
  extractUltaProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Ulta');
  }

  /**
   * Sephora product extraction
   */
  extractSephoraProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Sephora');
  }

  /**
   * Alibaba product extraction
   */
  extractAlibabaProduct() {
    ...
    return this.extractWithSelectors(selectors, 'Alibaba');
  }
  ...
  extractAliExpressProduct() {
    ...
    return this.extractWithSelectors(selectors, 'AliExpress');
  }

  /**
   * Wish product extraction
   */
  extractWishProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Wish');
  }

  /**
   * Instacart product extraction
   */
  extractInstacartProduct() {
    const selectors = {
      title: [
    ...
    return this.extractWithSelectors(selectors, 'Instacart');
  }

  /**
   * Kroger product extraction
   */
  extractKrogerProduct() {
    const selectors = {
      title: [
        'h1[data-testid="product-title"]',
    ...
    return this.extractWithSelectors(selectors, 'Kroger');
  }

  /**
   * AutoZone product extraction
   */
  extractAutoZoneProduct() {
    const selectors = {
      title: [
        'h1.product-name',
        '.pdp-product-name'
    ...
    return this.extractWithSelectors(selectors, 'AutoZone');
  }

  /**
   * O'Reilly Auto Parts product extraction
   */
  extractOReillyProduct() {
    const selectors = {
      title: [
        'h1.pdp-product-name',
        '.product-title'
    ...
    return this.extractWithSelectors(selectors, "O'Reilly Auto Parts");
  }
