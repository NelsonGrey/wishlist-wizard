...
2. Set up an update URL in your manifest.json:
   ...
   ```json
   "update_url": "https://wishkeeper.replit.app/updates/updates.xml"
   ```
...
3. Create an XML file at that location with update information:
   ...
   <gupdate xmlns='http://www.google.com/update2/response' protocol='2.0'>
     <app appid='[YOUR_EXTENSION_ID]'>
       <updatecheck codebase='https://wishkeeper.replit.app/updates/wishkeeper-extension.zip' version='1.0.0' />
     </app>
   </gupdate>
   ```
...
- Email: dev-support@wishkeeper.replit.app
