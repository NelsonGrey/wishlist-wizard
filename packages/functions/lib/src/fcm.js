...
exports.sendBatchNotification = exports.sendTestNotification = exports.notifyPriceAlert = exports.notifyItemPurchased = exports.notifyItemReserved = exports.notifyItemAdded = exports.sendTestPushNotification = exports.unsubscribeFromTopic = exports.subscribeToTopic = exports.removeFCMToken = exports.saveFCMToken = void 0;
...
exports.sendTestPushNotification = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        firebase_functions_1.logger.info(`Test notification sent to user ${request.auth.uid}`);
        return { success: true };
    }
    catch (error) {
