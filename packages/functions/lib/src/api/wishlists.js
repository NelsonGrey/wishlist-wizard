...
exports.deleteWishlistItem = exports.updateWishlistItem = exports.addWishlistItem = exports.getWishlistItems = exports.deleteWishlist = exports.updateWishlist = exports.createWishlist = exports.getSharedWishlist = exports.getWishlistById = exports.getUserWishlists = void 0;
...
exports.addWishlistItem = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        const affiliateConversion = productUrl ? (0, affiliate_js_1.convertAffiliateUrl)(productUrl) : null;
        const itemData = {
            wishlistId,
            title: title.trim(),
            description: description || '',
            price: price || null,
            productUrl: (affiliateConversion === null || affiliateConversion === void 0 ? void 0 : affiliateConversion.wasConverted) ? affiliateConversion.convertedUrl : productUrl || null,
            ...
            reservedBy: null,
            purchasedBy: null,
            metadata: (affiliateConversion === null || affiliateConversion === void 0 ? void 0 : affiliateConversion.wasConverted)
                ? {
                    affiliateConversion: {
                        originalUrl: affiliateConversion.originalUrl,
                        affiliateProgram: ((_a = affiliateConversion.program) === null || _a === void 0 ? void 0 : _a.name) || null,
                        convertedAt: new Date().toISOString(),
                        commission: ((_b = affiliateConversion.program) === null || _b === void 0 ? void 0 : _b.defaultCommission) || 0,
 ...
 */
exports.updateWishlistItem = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    if (!itemId || !updates) {
        throw new https_1.HttpsError('invalid-argument', 'Item ID and updates are required');
    }
    try {
        ...
        if (((_a = wishlistDoc.data()) === null || _a === void 0 ? void 0 : _a.userId) !== request.auth.uid) {
            throw new https_1.HttpsError('permission-denied', 'You can only update your own items');
        }
        await db.collection('wishlistItems').doc(itemId).update(Object.assign(Object.assign({}, updates), { updatedAt: new Date() }));
        return Object.assign(Object.assign({ id: itemId }, itemData), updates);
    }
    catch (error) {
        v2_1.logger.error('Error updating wishlist item:', error);
        if (error instanceof https_1.HttpsError)
            throw error;
        throw new https_1.HttpsError('internal', 'Failed to update wishlist item');
    }
});
/**
 ...
 */
exports.deleteWishlistItem = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        if (((_a = wishlistDoc.data()) === null || _a === void 0 ? void 0 : _a.userId) !== request.auth.uid) {
            throw new https_1.HttpsError('permission-denied', 'You can only delete your own items');
        }
        await db.collection('wishlistItems').doc(itemId).delete();
        return { success: true };
    }
    catch (error) {
        v2_1.logger.error('Error deleting wishlist item:', error);
        if (error instanceof https_1.HttpsError)
            throw error;
        throw new https_1.HttpsError('internal', 'Failed to delete wishlist item');
    }
});
// Helper Functions
