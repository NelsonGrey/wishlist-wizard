...
exports.deleteUserAccount = exports.searchUsers = exports.createUserDocument = exports.updateUserProfile = exports.getCurrentUser = void 0;
...
exports.getCurrentUser = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        return Object.assign({ id: userRecord.uid, email: userRecord.email, displayName: userRecord.displayName || (userData === null || userData === void 0 ? void 0 : userData.displayName), photoURL: userRecord.photoURL || (userData === null || userData === void 0 ? void 0 : userData.avatarUrl), emailVerified: userRecord.emailVerified, createdAt: userRecord.metadata.creationTime }, userData);
    }
    catch (error) {
        v2_1.logger.error('Error getting current user:', error);
        throw new https_1.HttpsError('internal', 'Failed to get user information');
    }
});
/**
 * Update User Profile
...
exports.updateUserProfile = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        const userDocData = {};
        if (displayName !== undefined)
            userDocData.displayName = displayName;
        if (photoURL !== undefined)
            userDocData.avatarUrl = photoURL;
        if (username !== undefined)
            userDocData.username = username;
        if (bio !== undefined)
            userDocData.bio = bio;
        ...
        v2_1.logger.error('Error updating user profile:', error);
 ...
 */
exports.createUserDocument = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
    try {
        ...
        const userData = {
            ...
            username: ((_a = userRecord.email) === null || _a === void 0 ? void 0 : _a.split('@')[0]) || null,
        ...
        v2_1.logger.error('Error creating user document:', error);
...
exports.searchUsers = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        v2_1.logger.error('Error searching users:', error);
        throw new https_1.HttpsError('internal', 'Failed to search users');
    }
});
/**
 * Delete User Account
...
exports.deleteUserAccount = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        v2_1.logger.info(`User account deleted: ${uid}`);
        return { success: true };
    }
    catch (error) {
        v2_1.logger.error('Error deleting user account:', error);
