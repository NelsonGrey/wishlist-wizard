...
exports.trackExtensionEvent = exports.getExtensionAnalytics = exports.shareExtensionWishlist = exports.deleteExtensionItem = exports.createExtensionWishlist = exports.getExtensionRecentItems = exports.addItemFromExtension = exports.getExtensionWishlists = exports.authenticateExtension = void 0;
...
exports.addItemFromExtension = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        if (affiliateConversion === null || affiliateConversion === void 0 ? void 0 : affiliateConversion.wasConverted) {
            itemData.metadata = {
                affiliateConversion: {
 ...
 */
exports.shareExtensionWishlist = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        const wishlistData = wishlistDoc.data();
        if ((wishlistData === null || wishlistData === void 0 ? void 0 : wishlistData.userId) !== request.auth.uid) {
            throw new https_1.HttpsError('permission-denied', 'You can only share your own wishlists');
        }
        let shareId = wishlistData === null || wishlistData === void 0 ? void 0 : wishlistData.shareId;
        if (!shareId) {
            shareId = generateExtensionId();
        ...
        v2_1.logger.error('Error sharing wishlist from extension:', error);
        if (error instanceof https_1.HttpsError)
            throw error;
        throw new https_1.HttpsError('internal', 'Failed to share wishlist');
    }
});
/**
 ...
 */
exports.trackExtensionEvent = (0, https_1.onCall)(async (request) => {
    var _a;
    ...
    try {
        ...
        v2_1.logger.error('Error tracking extension event:', error);
        throw new https_1.HttpsError('internal', 'Failed to track extension event');
    }
});
// Helper Functions
