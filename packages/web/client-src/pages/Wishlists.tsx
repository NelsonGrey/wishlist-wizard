  ...
  return (
    <>
      <main className="flex-1">
        <div data-testid="wishlists-page" className="container mx-auto px-4 py-6 2xl:py-8 max-w-7xl">
          <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <h1 data-testid="wishlists-title" className="text-4xl font-bold bg-gradient-to-r from-emerald-800 to-green-800 bg-clip-text text-transparent">My Wishlists</h1>
            <Button
              data-testid="wishlists-create-wishlist"
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        data-testid="wishlists-getting-started-dismiss"
                      >
                        <X className="h-4 w-4" />
                      </Button>
                    </TooltipTrigger>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-16 bg-white rounded-lg shadow-sm border">
              ...
              <Button
                data-testid="wishlists-empty-create-wishlist"
                onClick={() => setIsCreateDialogOpen(true)}
                disabled={createWishlistMutation.isPending}
