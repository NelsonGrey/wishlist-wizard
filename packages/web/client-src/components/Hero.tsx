...
export default function Hero() {
  return (
    <section className="bg-white px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 rounded-lg border border-emerald-100 bg-emerald-900 px-6 py-12 text-white shadow-sm sm:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:px-10 lg:py-16">
        <div className="flex max-w-3xl flex-col justify-center">
          <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-emerald-200/50 bg-white/10 px-4 py-2 text-sm font-semibold text-emerald-50">
