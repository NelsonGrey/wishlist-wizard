    ...
    <div className="notification-dropdown relative">
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button variant="ghost" size="icon" className="relative" aria-label={`Open notifications${unreadCount > 0 ? `, ${unreadCount} unread` : ''}`}>
          ...
          <ScrollArea className="h-[400px]">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center p-6 text-center">
                <Bell className="h-10 w-10 text-muted-foreground mb-2" aria-hidden="true" />
