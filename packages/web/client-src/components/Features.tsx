...
export default function Features() {
  return (
    <>
            ...
            {personas.map((persona) => {
              ...
              return (
                <article key={persona.label} className="flex h-full flex-col rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <Link
                    href={persona.href}
                    className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-emerald-800 hover:text-emerald-950"
                  >
      ...
      <section className="bg-white px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 rounded-lg border border-emerald-100 bg-emerald-50/60 p-6 sm:p-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <Link
              href="/extension"
              className="mt-7 inline-flex items-center gap-2 rounded-lg bg-emerald-800 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-emerald-900"
            >
