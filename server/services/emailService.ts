...
export class EmailService {
  ...
  private defaultFromEmail = 'notifications@wishkeeper.com';
  private defaultFromName = 'WishKeeper';
  ...
  async sendPriceDropNotification(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Good news! An item on your WishKeeper wishlist has dropped in price:</p>
  ...
  async sendWishlistActivityNotification(
    ...
    const subject = `WishKeeper: New activity on "${wishlistName}"`;
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>There's been new activity on your WishKeeper wishlist:</p>
        <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 16px 0;">
  ...
  async sendWelcomeEmail(
    ...
    const subject = `Welcome to WishKeeper!`;
    const text = `Welcome to WishKeeper, ${userName}! We're excited to have you on board. Start creating your wishlists today.`;
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #4f46e5;">Welcome to WishKeeper!</h2>
        <p>Hi ${userName},</p>
        <p>We're thrilled to have you join our community of wishlist enthusiasts!</p>
        <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 16px 0;">
          <h3 style="margin: 0 0 8px 0;">Get Started with WishKeeper:</h3>
          ...
          <a href="https://wishkeeper.com/dashboard" style="display: inline-block; background-color: #4f46e5; color: white; padding: 10px 16px; text-decoration: none; border-radius: 4px; margin-top: 16px;">Go to Dashboard</a>
        </div>
  ...
  async sendCollaborationInvite(
    ...
    const subject = `WishKeeper: ${inviterName} invited you to collaborate on "${wishlistName}"`;
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>${inviterName} has invited you to collaborate on a WishKeeper wishlist:</p>
        <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 16px 0;">
          <h3 style="margin: 0 0 8px 0;">${wishlistName}</h3>
  ...
  async sendPasswordResetEmail(
    ...
    const subject = `Reset Your WishKeeper Password`;
    const text = `You requested to reset your WishKeeper password. Click the following link to reset it: ${resetUrl}. If you didn't request this, please ignore this email.`;
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #4f46e5;">Reset Your Password</h2>
        <p>We received a request to reset your WishKeeper password.</p>
        <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 16px 0;">
  ...
  async sendWishlistSharedNotification(
    ...
    const subject = `WishKeeper: ${sharerName} shared a wishlist with you`;
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>${sharerName} has shared a WishKeeper wishlist with you:</p>
        <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 16px 0;">
          <h3 style="margin: 0 0 8px 0;">${wishlistName}</h3>
